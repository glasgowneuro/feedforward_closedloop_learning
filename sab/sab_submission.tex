...
300 inputs in total.  The network consists of an input layer, two
hidden layers and an output layer which are all fully connected.
The four ground sensors in
...
is consistently successful. For high learning rates learning is virtually
instantaneous and approaches one shot learning. 
We also plot the smoothed KD for the final
