...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\columnwidth]{FPSFig4}
	\caption{A) Time to success vs learning rate. B) KD at end of trial. C) Typical output in time. D) KD learning curves. E) Typical weight growth. F) Example input weights. G) Example input frame.
