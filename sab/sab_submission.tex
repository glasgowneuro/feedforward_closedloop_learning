...
function $P_1$ and appear as additional inputs $V_i$ -- where we have
...
perspective of the error signal is \textsl{Hebbian} because it coorrelates a
...
Looking at a system-wide perspective FCL offers an answer how errors
can propagated further beyond its immeditate targets which has been a mystery
...
which is able to propagate this error signal further into the cortex
...
prediction error, and then the following stages, that project back to
the cortex, use instead cross frequency coupling as described above
\cite{Lipski2017}.
