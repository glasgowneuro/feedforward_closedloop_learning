...
namespace Enki
{
	Racer::Racer(int _nSensors,
		...
		groundSensorLeft (this, Vector(10, 15), 0, 1, 1, 0),
		groundSensorRight(this, Vector(10, -15),0, 1, 1, 0),
		groundSensorLeft2 (this, Vector(10, 25), 0, 1, 1, 0),
		groundSensorRight2(this, Vector(10, -25),0, 1, 1, 0)
	{
		nSensors = _nSensors;
		if (nSensors%2) {
