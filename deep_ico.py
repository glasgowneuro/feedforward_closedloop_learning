...
class DeepFeedbackLearning(_object):
    ...
    def __init__(self, *args):
        this = _deep_ico.new_DeepFeedbackLearning(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _deep_ico.delete_DeepFeedbackLearning
    __del__ = lambda self: None
    backprop = _deep_ico.DeepFeedbackLearning_backprop
    ico = _deep_ico.DeepFeedbackLearning_ico

    def doStep(self, *args) -> "void":
        return _deep_ico.DeepFeedbackLearning_doStep(self, *args)

    def getOutput(self, index: 'int') -> "double":
        return _deep_ico.DeepFeedbackLearning_getOutput(self, index)

    def setLearningRate(self, learningRate: 'double') -> "void":
        return _deep_ico.DeepFeedbackLearning_setLearningRate(self, learningRate)

    def setAlgorithm(self, _algorithm: 'DeepFeedbackLearning::Algorithm') -> "void":
        return _deep_ico.DeepFeedbackLearning_setAlgorithm(self, _algorithm)

    def getAlgorithm(self) -> "DeepFeedbackLearning::Algorithm":
        return _deep_ico.DeepFeedbackLearning_getAlgorithm(self)

    def initWeights(self, max: 'double') -> "void":
        return _deep_ico.DeepFeedbackLearning_initWeights(self, max)

    def seedRandom(self, s: 'int') -> "void":
        return _deep_ico.DeepFeedbackLearning_seedRandom(self, s)

    def getHiddenLayer(self) -> "Layer *":
        return _deep_ico.DeepFeedbackLearning_getHiddenLayer(self)

    def getOutputLayer(self) -> "Layer *":
        return _deep_ico.DeepFeedbackLearning_getOutputLayer(self)

    def setUseDerivative(self, useIt: 'int') -> "void":
        return _deep_ico.DeepFeedbackLearning_setUseDerivative(self, useIt)
DeepFeedbackLearning_swigregister = _deep_ico.DeepFeedbackLearning_swigregister
